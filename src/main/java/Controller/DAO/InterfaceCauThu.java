...
public class InterfaceCauThu implements DAOInterface<MODEL_CAUTHU>{

    @Override
    public int insertDB(MODEL_CAUTHU modelCauthu) {
        return 0;
    }

    @Override
    public int updateDB(MODEL_CAUTHU modelCauthu) {
        return 0;
    }
    ...
    @Override
    public ArrayList<MODEL_CAUTHU> selectByID(String id) {
        return null;
    }
